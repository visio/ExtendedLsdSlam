...
(cl:defmethod cl:initialize-instance :after ((m <keyframeGraphMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keyframeGraphMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myTestViewer-msg:<keyframeGraphMsg> is deprecated: use myTestViewer-msg:keyframeGraphMsg instead.")))

(cl:ensure-generic-function 'numFrames-val :lambda-list '(m))
(cl:defmethod numFrames-val ((m <keyframeGraphMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:numFrames-val is deprecated.  Use myTestViewer-msg:numFrames instead.")
  (numFrames m))

(cl:ensure-generic-function 'frameData-val :lambda-list '(m))
(cl:defmethod frameData-val ((m <keyframeGraphMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:frameData-val is deprecated.  Use myTestViewer-msg:frameData instead.")
  (frameData m))

(cl:ensure-generic-function 'numConstraints-val :lambda-list '(m))
(cl:defmethod numConstraints-val ((m <keyframeGraphMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:numConstraints-val is deprecated.  Use myTestViewer-msg:numConstraints instead.")
  (numConstraints m))

(cl:ensure-generic-function 'constraintsData-val :lambda-list '(m))
(cl:defmethod constraintsData-val ((m <keyframeGraphMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:constraintsData-val is deprecated.  Use myTestViewer-msg:constraintsData instead.")
  (constraintsData m))
