...
(cl:in-package myTestViewer-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <keyframeMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'keyframeMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myTestViewer-msg:<keyframeMsg> is deprecated: use myTestViewer-msg:keyframeMsg instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:id-val is deprecated.  Use myTestViewer-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:time-val is deprecated.  Use myTestViewer-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'isKeyframe-val :lambda-list '(m))
(cl:defmethod isKeyframe-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:isKeyframe-val is deprecated.  Use myTestViewer-msg:isKeyframe instead.")
  (isKeyframe m))

(cl:ensure-generic-function 'camToWorld-val :lambda-list '(m))
(cl:defmethod camToWorld-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:camToWorld-val is deprecated.  Use myTestViewer-msg:camToWorld instead.")
  (camToWorld m))

(cl:ensure-generic-function 'fx-val :lambda-list '(m))
(cl:defmethod fx-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:fx-val is deprecated.  Use myTestViewer-msg:fx instead.")
  (fx m))

(cl:ensure-generic-function 'fy-val :lambda-list '(m))
(cl:defmethod fy-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:fy-val is deprecated.  Use myTestViewer-msg:fy instead.")
  (fy m))

(cl:ensure-generic-function 'cx-val :lambda-list '(m))
(cl:defmethod cx-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:cx-val is deprecated.  Use myTestViewer-msg:cx instead.")
  (cx m))

(cl:ensure-generic-function 'cy-val :lambda-list '(m))
(cl:defmethod cy-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:cy-val is deprecated.  Use myTestViewer-msg:cy instead.")
  (cy m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:height-val is deprecated.  Use myTestViewer-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:width-val is deprecated.  Use myTestViewer-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'pointcloud-val :lambda-list '(m))
(cl:defmethod pointcloud-val ((m <keyframeMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myTestViewer-msg:pointcloud-val is deprecated.  Use myTestViewer-msg:pointcloud instead.")
  (pointcloud m))
